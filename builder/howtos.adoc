...
Ive refactored Mob Ranks, such that they live in a new field, along side the +
species:
...
is less important... the intention is that the skills will propagate there + automatically eventually.
