...
#define ITEM_EGO                BIT_2   /*  Item has special effects and powers;
                                              was ITEM_DARK */
 ...
 */
#define EGO_ITEM_BLOODLUST        BIT_0    /* Wearer may not flee; wimpy ignored; attacks
                                                creatures at random */
#define EGO_ITEM_SOUL_STEALER     BIT_1    /* Weapon: drains hits, mana and move after some
                                                successful hits */
#define EGO_ITEM_FIREBRAND        BIT_2    /* Weapon: inflicts fire damage after some
                                                successful hits */
#define EGO_ITEM_BATTLE_TERROR    BIT_3    /* Wearer may automatically try to flee after
                                                being hit; may become terrified and unable
                                                to act in combat */
...
extern  int     gsn_transport;  /*trasport object - Istari */
...
DECLARE_DO_FUN( do_combo        );      /* martial artists combo's */
...
DECLARE_DO_FUN( do_feed         );      /* for va,ps - Matt */
...
#define MOB_VNUM_SKELATON  3404  /* What's a "skelaton" exackry? */
...
void    mprog_percent_check     args(( CHAR_DATA *mob, CHAR_DATA* actor,
                                      OBJ_DATA* object, void* vo, int type ) );
void    mprog_act_trigger       args(( char* buf, CHAR_DATA* mob, CHAR_DATA* ch,
