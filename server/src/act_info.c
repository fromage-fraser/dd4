...
void do_score (CHAR_DATA *ch, char *argument)
{
        ...
        */
        ...
        else if( GET_AC( ch ) >= 25 ) strcat( buf1, "slightly armoured.\n\r" );
        else if( GET_AC( ch ) >= 0 ) strcat( buf1, "somewhat armoured.\n\r" );
        else if( GET_AC( ch ) >= - 25) strcat( buf1, "armoured.\n\r" );
        else if( GET_AC( ch ) >= - 50 ) strcat( buf1, "well-armoured.\n\r"     );
        else if( GET_AC( ch ) >= - 75 ) strcat( buf1, "strongly armoured.\n\r" );
        else if ( GET_AC( ch ) >= - 100 ) strcat( buf1, "heavily armoured.\n\r"  );
        else if ( GET_AC( ch ) >= - 150 ) strcat( buf1, "superbly armoured.\n\r" );
        else if ( GET_AC( ch ) >= - 200 ) strcat( buf1, "divinely armoured.\n\r" );
