...
typedef enum
{
   ...
   /* Config */
   GMCP_CONFIG_AUTOEXIT,
   GMCP_CONFIG_AUTOLOOT,
   GMCP_CONFIG_AUTOSAC,
   GMCP_CONFIG_AUTOCOIN,
   GMCP_CONFIG_AUTOWIELD,
   GMCP_CONFIG_AUTOLEVEL,
   GMCP_CONFIG_BLANK,
   GMCP_CONFIG_BRIEF,
   GMCP_CONFIG_COMBINE,
   GMCP_CONFIG_TARGETMODE,
   GMCP_CONFIG_PROMPT,
   GMCP_CONFIG_ANSI,
   GMCP_CONFIG_GAG,
   GMCP_CONFIG_QUIET,
   GMCP_CONFIG_ALLOWEQ,
   GMCP_CONFIG_TELNETGA,
   GMCP_CONFIG_TELL,
